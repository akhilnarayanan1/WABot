const getGroupInfo = async (msg, socket) => {
    const { getGroupAdmins } = require('../functions')
...
const GroupUser = async (type, args, msg, socket) => {     
...
const GroupInviteCode = async(msg, socket) => {
    const { sendMessageWTyping } = require('../functions')
